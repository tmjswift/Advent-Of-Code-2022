...
# Avoid worry values getting too big by dividing them by this number and taking the remainder
# This will not affect the various tests for which monkey to pass to
lowestCommonMultiple = 9699690
...
for i in range(10000):
    ...
    for worryValue in monkeyItems[0]:
        ...
        newWorryValue = (worryValue * 3)
        newWorryValue = newWorryValue % lowestCommonMultiple
    ...
    for worryValue in monkeyItems[1]:
        ...
        newWorryValue = (worryValue * worryValue)
        newWorryValue = newWorryValue % lowestCommonMultiple
    ...
    # if i % 50 == 0:
    #     print("Loopcounter:", i, "monkeyInspectionCount:", monkeyInspectionCount)
    #     print("monkeyItems:", monkeyItems)
